...
const Page = ()=>{
    return(
        <div className="flex-col justify-items-center w-full bg-gradient-to-br from-[rgb(18,27,19)] to-[rgb(19,78,32)] py-12 rounded-md">
                                ...
                                <AccordionContent>
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm">If you're a winner:
